...
vim.keymap.set('n', '<leader>gf', require('telescope.builtin').git_files, { desc = 'Search [G]it [F]iles' }) -- what's that
...
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' }) -- yyy
vim.keymap.set('n', '<leader>sg', require('telescope.builtin').live_grep, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', '<leader>sd', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })
vim.keymap.set('n', '<leader>sc', require('telescope').extensions.flutter.commands,
  { desc = '[S]earch flutter [c]ommands' })
  ...
  lua_ls = {
    Lua = {
      ...
      diagnostics = {
        ...
        library = {
          "/home/p/Applications/love2d/love-11.5-x86_64.AppImage",
        }
      }
    },
  },
      ...
      dap.configurations.dart = {
        {
          ...
          request = "launch",
          name = "Launch dart",
          dartSdkPath = "/usr/local/flutter/bin/dart",
